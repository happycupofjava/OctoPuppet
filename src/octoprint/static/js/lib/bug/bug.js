...
var BugDispatch = {
    ...
    options: {
        ...
        maxSmallTurnDeg: 10,
        maxWiggleDeg: 5,
        imageSprite: 'static/img/fly-sprite.png',
        bugWidth: 13,
        bugHeight: 14,
        num_frames: 5,
        zoom: 5, // random zoom variation from 1 to 10 - 10 being full size.
        canFly: true,
        canDie: true,
        numDeathTypes: 3,
        ...
        mouseOver: 'fly' // can be 'fly', 'flyoff' (if the bug can fly), die', 'multiply', 'nothing' or 'random'
    },
...
var SpiderController = function() {
    var spiderOptions = {
        imageSprite: 'static/img/spider-sprite.png',
        bugWidth: 69,
        bugHeight: 90,
        num_frames: 7,
        canFly: false,
